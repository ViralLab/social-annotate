// Immediate things to correct:
//     1- CSS needs to be updated, it both covers too much of the site and looks wonky.
//          a- Need to fix bottom alignment div height issues, it won't work if survey is longer than 1 rows as it is.
//     2- Config files, storage, and etc. needs to be updated to show and handle instagram functions properly.
//          a- Including downloading results, importing/exporting config, etc.
...
// new Context('instagram-post', enableInstagramObserver, null)
// Start with user annotation only
...
function checkUserURL() {
    ...
    return !(uname === '' || uname === 'home')  // main page looks like ?hl=en or just nothing., there is also /direct/inbox, /explore,
    /*
