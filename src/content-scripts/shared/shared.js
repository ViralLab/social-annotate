...
const _CAPTURED_KEYS = new Set(['body', 'created_at', 'media_urls', 'post_metrics', 'user_profile', 'subreddit', 'comment_depth', 'parent_post_id', 'parent_comment_id', 'video_id']);
    ...
    try {
        chrome.storage.local.get(['resultsArrays', 'annotatedElements', 'activeTargetList', 'isGuided', 'clientID'], function (result) {
            ...
            if (surveyType === 'x-user') {
                ...
                insertKey = surveyResults.account_id;
            } else if (surveyType === 'youtube-comment') {
                insertKey = surveyResults.post_id;
                ...
                insertKey = surveyResults.post_id;
            } else if (surveyType === 'instagram-comment') {
                insertKey = surveyResults.post_id;
